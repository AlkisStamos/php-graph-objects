...
use Nuad\Graph\Test\Tests\GraphMixed;
...
class MixedTypeTest extends TestCase
{
    public function testMixedValue()
    {
        ...
        $this->assertInstanceOf(GraphSimple::class,$obj->simpleMixed);
    ...
    public function testCustomAdapterMixedValue()
    {
        ...
        $this->assertInstanceOf(GraphObjectBase::class,$base);
        ...
        $this->assertInstanceOf(GraphSimple::class,$simple);
        ...
        $this->assertInstanceOf(GraphObjectBase::class,$obj->mixedCustomProperties['base']);
        ...
        $this->assertInstanceOf(GraphSimple::class,$obj->mixedCustomProperties['simple']);
